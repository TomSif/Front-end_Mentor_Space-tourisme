...
function Crew() {
  ...
  return (
    ...
    >
      {/* CONTENT */}
      <section className="grid grid-cols-1 lg:grid-cols-2 items-center  lg:grid-rows-1 justify-center pt-30 md:pt-34 md:pb-32 lg:mb-8 gap-6 lg:gap-0 w-full lg:max-w-277">
        ...
        <div className="w-full flex  flex-col items-center  md:max-w-lg lg:max-w-full justify-self-center pt-10 md:pt-6 lg:items-start lg:pt-32 gap-2 lg:col-start-1">
