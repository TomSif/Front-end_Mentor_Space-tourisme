...
function Technology() {
  ...
  return (
    ...
    >
      {/* CONTENT */}
      <section className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] items-center  lg:grid-rows-1 justify-center pt-28 md:pt-34 md:pb-32 lg:mb-8 gap-6 lg:gap-0 w-full  lg:overflow-hidden lg:max-w-319">
